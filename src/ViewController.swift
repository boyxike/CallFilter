...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.deepAR.setLicenseKey("f65fc29677f80410a3740de5d835682bc678d35818d2152fef4b93629e1515d010090c5172529746")
        self.deepAR.createARView(withFrame: self.view.frame)
    }
...
extension ViewController: DeepARDelegate {
    ...
    func didInitialize() {
        deepAR.switchEffect(withSlot: "effect", path: Bundle.main.path(forResource: "lion", ofType: ""))
        deepAR.startCapture(withOutputWidth: 640, outputHeight: 0, subframe: CGRect(x: 0, y: 0, width: 1, height: 1))
    }
}
